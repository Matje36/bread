...
class VoiceTracker(commands.Cog):
    ...
    async def generate_gta_card(self, user: discord.User, data):
        # Canvas Settings
        # VERANDERD: Hoogte aangepast van 1100 naar 1250 zodat alles past
        ...
        # Fonts
        font_header_bold = load_font("arialbd.ttf", 110)
        font_label = load_font("arialbd.ttf", 65)
        font_value = load_font("arial.ttf", 45)
