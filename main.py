...
# ---------------------------------------------------------
# YOUTUBE MUSIC SYSTEM (FIXED & FULLY WORKING)
# ---------------------------------------------------------
...
class MusicSystem(commands.Cog):
    ...
    @youtube_group.command(name="play", description="Play or queue a YouTube song.")
    ...
    @youtube_group.command(name="pause", description="Pause music")
    @app_commands.guilds(discord.Object(id=GUILD_ID))
    async def pause(self, interaction: discord.Interaction):
        vc = interaction.guild.voice_client
        if vc and vc.is_playing():
            vc.pause()
            return await interaction.response.send_message("⏸️ Music paused.")
        await interaction.response.send_message("❌ Nothing is playing.", ephemeral=True)

    @youtube_group.command(name="resume", description="Resume music")
    @app_commands.guilds(discord.Object(id=GUILD_ID))
    async def resume(self, interaction: discord.Interaction):
        vc = interaction.guild.voice_client
        if vc and vc.is_paused():
            vc.resume()
            return await interaction.response.send_message("▶️ Music resumed.")
    ...
    @youtube_group.command(name="queue", description="Show current song queue")
    @app_commands.guilds(discord.Object(id=GUILD_ID))
    ...
    @youtube_group.command(name="testsound", description="Check if audio works (FFmpeg test)")
    @app_commands.guilds(discord.Object(id=GUILD_ID))
    async def testsound(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.followup.send("🔊 Test sound playing! If you hear it, FFmpeg works.")
        except Exception as e:
