...
class VoiceTracker(commands.Cog):
    ...
    async def generate_gta_card(self, user: discord.User, data):
        # Canvas Settings
        # VERANDERD: Hoogte aangepast van 1250 naar 1450 zodat grotere tekst past
        WIDTH, HEIGHT = 900, 1450
        ...
        # Fonts VERANDERD: Veel groter gemaakt
        font_header_bold = load_font("arialbd.ttf", 110) # Was 80
        font_label = load_font("arialbd.ttf", 65)       # Was 45
        font_value = load_font("arial.ttf", 65)         # Was 45
        ...
        for y in range(banner_h):
            alpha = int(255 * (1 - (y / banner_h))) # Fade out at bottom
        ...
        # Paste banner onto card using the gradient as mask for smooth transition
        card.paste(banner, (0, 0), mask=gradient)
        ...
        start_y = name_y + 110
        item_height = 100 # VERANDERD: Was 75, groter gemaakt voor grotere tekst
        margin_x = 50
        ...
        for i, (label, value) in enumerate(stats_list):
            ...
            row_draw.rectangle([margin_x, 0, margin_x + 8, item_height], fill=(50, 205, 50))
