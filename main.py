...
#event lisent 
    ...
    async def generate_gta_card(self, user: discord.User, data):
        ...
        try:
            ...
            username_font = ImageFont.truetype("arial.ttf", 80)  # Increased size for name
            base_title_font = ImageFont.truetype("arial.ttf", 90)  # Much bigger base for title
        except Exception:
        ...
        def fit_font_for_width(text, base_font, max_width, min_size=80):
        ...
        try:
            username_bold_font = ImageFont.truetype("arialbd.ttf", 80)  # Bigger and bold hieeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeer 60
        except:
