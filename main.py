...
#event lisent 
    ...
    async def generate_gta_card(self, user: discord.User, data):
        ...
        try:
            ...
            stat_font = ImageFont.truetype("arial.ttf", 1000)
            label_font = ImageFont.truetype("arial.ttf", 1000)
            username_font = ImageFont.truetype("arial.ttf", 1200)  # Increased size for name
            base_title_font = ImageFont.truetype("arial.ttf", 1200)  # Much bigger base for title
        except Exception:
        ...
        def fit_font_for_width(text, base_font, max_width, min_size=100):
        ...
        banner = banner.filter(ImageFilter.GaussianBlur(radius=5)) # bluuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuur 18
        ...
        try:
            username_bold_font = ImageFont.truetype("arialbd.ttf", 240)  # Bigger and bold hieeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeer 60
        except:
        ...
        try:
            label_big = ImageFont.truetype("arialbd.ttf", 1000)  # Bigger and bold
            value_big = ImageFont.truetype("arialbd.ttf", 1200)  # Bigger and bold  kaksalikslakalkslaklsaklasklakslkalskalkslaklkdddddddddddddddddddddddddddddddddddddddddddd 64
        except Exception:
            try:
                label_big = ImageFont.truetype("arial.ttf", 1000)  # Fallback to regular
                value_big = ImageFont.truetype("arial.ttf", 1200)# Bigger and bold  kaksalikslakalkslaklsaklasklakslkalskalkslaklk 64
            except Exception:
