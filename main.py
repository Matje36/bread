...
#event lisent 
    ...
    async def generate_gta_card(self, user: discord.User, data):
        ...
        try:
            ...
            stat_font = ImageFont.truetype("arial.ttf", 90)
            label_font = ImageFont.truetype("arial.ttf", 90)
            username_font = ImageFont.truetype("arial.ttf", 160)  # Increased size for name
        ...
        banner = banner.filter(ImageFilter.GaussianBlur(radius=18)) # bluuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuur 18
