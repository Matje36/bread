...
#event lisent 
    ...
    async def generate_gta_card(self, user: discord.User, data):
        ...
        try:
            label_big = ImageFont.truetype("arialbd.ttf", 120)  # Bigger and bold
            value_big = ImageFont.truetype("arialbd.ttf", 160)  # Bigger and bold  kaksalikslakalkslaklsaklasklakslkalskalkslaklkdddddddddddddddddddddddddddddddddddddddddddd 64
        except Exception:
            try:
                label_big = ImageFont.truetype("arial.ttf", 120)  # Fallback to regular
                value_big = ImageFont.truetype("arial.ttf", 160)# Bigger and bold  kaksalikslakalkslaklsaklasklakslkalskalkslaklk 64
            except Exception:
