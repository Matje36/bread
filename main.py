...
#event lisent 
    ...
    async def generate_gta_card(self, user: discord.User, data):
        ...
        try:
            ...
            stat_font = ImageFont.truetype("arial.ttf", 1500)
            label_font = ImageFont.truetype("arial.ttf", 1500)
            username_font = ImageFont.truetype("arial.ttf", 1800)  # Increased size for name
            base_title_font = ImageFont.truetype("arial.ttf", 1800)  # Much bigger base for title
        except Exception:
